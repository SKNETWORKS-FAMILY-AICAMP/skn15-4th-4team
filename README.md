...
| 강민정 |프로젝트를 진행하면서 어려운 부분이나 고민되는 지점이 있을 때, 팀원들과 함께 의견을 나누며 해결해 나간 경험이 큰 도움이 되었습니다. 특히 도커와 컨테이너 개념을 이해하고, Django를 활용해 데이터베이스를 구현해 본 경험이 프로젝트를 진행하는 데 많은 도움이 되었습니다.|
